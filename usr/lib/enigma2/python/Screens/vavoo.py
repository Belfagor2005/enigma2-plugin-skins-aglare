...
# def Plugins(**kwargs):
	# return [PluginDescriptor(name="vavoo maker playlists", description=_("Make IPTV bouquets based on m3u playlists from github.com/vavoo"), where=PluginDescriptor.WHERE_PLUGINMENU, icon="icon.png", needsRestart=True, fnc=PluginMain)]
