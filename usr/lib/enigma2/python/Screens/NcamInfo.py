...
config.NcamInfo.username = ConfigText(
    default="username",
    fixed_size=False,
    visible_width=12)
    ...
    def goEntry(self, entry):
        ...
        if NAMEBIN:
            ...
            if entry in (
                    1,
                    2,
                    3) and config.NcamInfo.userdatafromconf.value and self.osc.confPath()[0] is None:
            ...
            self.session.open(
                MessageBox,
                _("Ncam not running - start Cam to obtain information."),
                MessageBox.TYPE_INFO)
